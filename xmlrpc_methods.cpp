...
void
PingMethod::execute(const xmlrpc_c::paramList& paramList, xmlrpc_c::value* const retval)
{
...
void
InitGameMethod::execute(const xmlrpc_c::paramList& paramList, xmlrpc_c::value* const retval)
{
...
void
GetBidMethod::execute(const xmlrpc_c::paramList& paramList, xmlrpc_c::value* const retval)
{
...
void
MakeChoiceMethod::execute(const xmlrpc_c::paramList& paramList, xmlrpc_c::value* const retval)
{
    std::vector<xmlrpc_c::value> offer = paramList.getArray(0);
    std::map<std::string, xmlrpc_c::value> gstate = paramList.getStruct(1);
...
void
MoveResultMethod::execute(const xmlrpc_c::paramList& paramList, xmlrpc_c::value* const retval)
{
